...
void CANModule::initializeCAN() {
    ...
    #ifdef MASK 
        mcp2515.init_Mask(0, 0, MASK);                 // Mask0 for Filter 0 and Filter 1
        mcp2515.init_Mask(1, 0, MASK);                 // Mask1 for Filters 2, 3,4 and 5 (there are only 6 filters total. See explanation at: https://forum.arduino.cc/t/mcp2515-can-filtering/506401 )
    #endif
