...
#define FL1_IND_LED_Pin GPIO_PIN_5
#define FL1_IND_LED_GPIO_Port GPIOC
#define FL2_IND_LED_Pin GPIO_PIN_0
#define FL2_IND_LED_GPIO_Port GPIOB
#define FL3_IND_LED_Pin GPIO_PIN_1
#define FL3_IND_LED_GPIO_Port GPIOB
#define PB1_IN_Pin GPIO_PIN_12
#define PB1_IN_GPIO_Port GPIOB
#define PB1_IN_EXTI_IRQn EXTI15_10_IRQn
